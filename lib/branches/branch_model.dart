...
//
//   /// Keeps any additional fields returned by the API.
...
//     }
//
//     final openTime = parseTime(json['Open_Time']);
//     final closeTime = parseTime(json['Close_Time']);
//
//     return Branch(
...
//   }
//
//   Branch copyWith({String? phone1, String? phone2, String? googleRateUrl}) {
//     return Branch(
//       id: id,
...
class Branch {
  ...
  factory Branch.fromJson(Map<String, dynamic> json) {
    // ============================================================
    // parseTime — تدعم:
    // "10:00" / "10:00:00" / "10:00 AM" / "10:00 PM"
    // ============================================================
    TimeOfDay? parseTime(dynamic value) {
      if (value == null) return null;
  ...
  // ============================================================
  // copyWith — الآن يدعم openTime و closeTime
  // ============================================================
  Branch copyWith({
    String? phone1,
    String? phone2,
