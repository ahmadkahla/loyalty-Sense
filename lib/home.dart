...
//           const SnackBar(
//             content: Text('🎉 +5 Points added!'),
//             backgroundColor: Color(0xFFFF0099), // 🎨 جديد
//           ),
//         );
//
//         await _loadLoyaltyCardFromApi();
...
class _SocialMediaSectionState extends State<_SocialMediaSection> {
  ...
  Widget build(BuildContext context) {
    ...
    //   ),
    //   child: SizedBox(
    //     height: 48, // ✅ ارتفاع ثابت يمنع الـ overflow نهائياً
    //     child: Row(
    //       crossAxisAlignment: CrossAxisAlignment.center,
    //       children: [
    //         Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // ============================================================
          // ICONS  (تبدأ من اليسار + حجم أكبر)
          // ============================================================
          SizedBox(
            height: 56, // ✅ ارتفاع يكفي للأيقونات المكبّرة
            child: SingleChildScrollView(
              controller: _scrollController,
              scrollDirection: Axis.horizontal,
              physics: const BouncingScrollPhysics(),
