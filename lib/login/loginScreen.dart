...
class _LoginScreenState extends State<LoginScreen>
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // ✅ تم التعديل هنا — المربعات تتوزع تلقائياً
              ...
              if (!_isVerifying && !_otpVerified)
                Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 6),
                    // ✅ تم التعديل — Flexible للنص التاني
                    Flexible(
  ...
  // ============================================================
  // 🎯 OTP BOXES (✅ تم التعديل — Expanded بدل عرض ثابت)
  // ============================================================
      ...
      child: Stack(
        ...
        children: [
          ...
          AnimatedBuilder(
            ...
            builder: (context, _) {
              if (!isInVerificationMode) {
                // ✅ الحل: Expanded لكل مربع — بدون عرض ثابت
                return IgnorePointer(
                  child: Row(
                    children: List.generate(4, (index) {
                      return Expanded(
  ...
  // ============================================================
  // 🎯 مربع OTP واحد (✅ تم التعديل — بدون width ثابت)
  // ============================================================
  Widget _buildSingleOtpBox({
    required int index,
    required bool isSmall,
    ...
    return AnimatedContainer(
      duration: const Duration(milliseconds: 300),
      curve: Curves.easeOut,
      // ✅ width: double.infinity بدل otpBoxWidth
      width: double.infinity,
