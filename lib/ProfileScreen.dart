...
//
//     debugPrint('🟣 [ProfileScreen] userName=${widget.userName}');
//     debugPrint('🟣 [ProfileScreen] customerNo=${widget.customerNo}');
//
//     _loadProfile();
//   }
//
...
//         debugPrint('🔴 [ProfileScreen] customerNo is empty');
//
//         if (!mounted) return;
//
//         setState(() {
...
//       }
//
//       debugPrint('🟣 [ProfileScreen] Loading profile: $customerNo');
//
...
//       result.fold(
//         (data) {
//           debugPrint('✅ [ProfileScreen] API data = $data');
//
//           final apiName =
...
//               '';
//
//           debugPrint('🟢 name=$apiName');
//           debugPrint('🟢 email=$apiEmail');
//           debugPrint('🟢 birthday=$apiBirthday');
//           debugPrint('🟢 phone=$apiPhone');
//
//           setState(() {
//             if (apiName.trim().isNotEmpty) {
//               _userName = apiName.trim();
//             }
//
//             if (apiEmail.trim().isNotEmpty) {
//               _email = apiEmail.trim();
//             }
//
//             if (apiBirthday.trim().isNotEmpty) {
//               _birthDate = apiBirthday.trim();
//             }
//
//             if (apiPhone.trim().isNotEmpty) {
//               _phone = apiPhone.trim();
//             }
//
//             _isLoading = false;
//           });
//         },
//         (failure) {
//           debugPrint('🔴 [ProfileScreen] Failed to load profile: $failure');
//
//           setState(() {
//             _isLoading = false;
//           });
...
//       );
//     } catch (e) {
//       debugPrint('🔴 [ProfileScreen] Exception: $e');
//
//       if (!mounted) return;
//
//       setState(() {
...
//
//   Future<void> _openEditProfile() async {
//     debugPrint('🟣 [ProfileScreen] Opening Edit Profile');
//
//     debugPrint('🟣 customerNo=${widget.customerNo}');
//
...
//                     // ==================================================
//                     Text(
//                       _userName.isEmpty ? 'No name'.tr() : _userName,
//                       textAlign: TextAlign.center,
//                       style: const TextStyle(
//                         fontSize: 22,
//                         fontWeight: FontWeight.w800,
...
//         icon: Icons.person_outline_rounded,
//         label: 'Name'.tr(),
//         value: _userName.isEmpty ? 'Not set'.tr() : _userName,
//       ),
//     );
//
//     if (_email.isNotEmpty) {
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    debugPrint('🟣 [ProfileScreen] Loading customer profile by phone=$phone');

    if (phone.isEmpty) {
      debugPrint('🔴 [ProfileScreen] phoneNumber is empty');
    ...
    try {
      ...
      result.fold(
        (data) {
          debugPrint('✅ [ProfileScreen] Customer API data = $data');
          ...
          setState(() {
            ...
            _birthDate = parsedDate != null
                ? '${parsedDate.day.toString().padLeft(2, '0')}/'
                      '${parsedDate.month.toString().padLeft(2, '0')}/'
                      '${parsedDate.year}'
                : apiBirthday.trim();

            _phone = apiPhone.trim().isNotEmpty ? apiPhone.trim() : phone;
        ...
        (failure) {
          debugPrint(
            '🔴 [ProfileScreen] Failed to load customer profile: $failure',
          );
